...
public class Alquiler{
	...
	public double Alquilerbarco() throws BarcoAlquilerException {
		if (fechafinal.isBefore(fechainicial)) throw new BarcoAlquilerException("Fecha inicial debe ser ante sque la fecha final") ;
